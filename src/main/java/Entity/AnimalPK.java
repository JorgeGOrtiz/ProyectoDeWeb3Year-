...
public class AnimalPK implements Serializable {
    ...
    public String toString() {
        return "BD_Usuarios.AnimalPK[ idAnimal=" + idAnimal + ", razaidRaza=" + razaidRaza + ", razaespecieanimalidEspecieAnimal=" + razaespecieanimalidEspecieAnimal + ", razaespecieanimalgrupoanimalidGrupoAnimal=" + razaespecieanimalgrupoanimalidGrupoAnimal + " ]";
    }
